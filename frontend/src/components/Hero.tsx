      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-5 md:px-8 pb-16 md:pb-24">
        ...
        >
          ...
          <button
            ...
            className="outline-button text-base"
          >
            {t.hero.cta2}
          </button>
        </div>
        ...
        >
          ...
          {info.trustChips[lang].map((chip) => (
            <span
              key={chip}
              className="text-xs uppercase tracking-wider text-foreground/50 bg-secondary/40 backdrop-blur-sm px-3 py-1.5 rounded-full border border-border/20"
            >
              {chip}
            </span>
          ))}
